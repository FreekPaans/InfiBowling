...
namespace BowlingGame.UnitTest {
    ...
    public class BowlingGameTest {
        ...
        [TestMethod]
        public void CurrentScoreBijStartIs0() {
            var game = GetGame();
        ...
        [TestMethod]
        public void TweeKeerGooi1GeeftScore2()
        {
            var game = GetGame();
        ...
        public void GooiMin1GeeftError()
        {
            var game = GetGame();
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidPinCountException))]
        public void GooiHogerDan10GeeftError()
        {
            var game = GetGame();
        ...
        [TestMethod]
        public void DrieKeerGooi1GeeftScore3()
        {
            var game = GetGame();
            ...
            Assert.AreEqual(3, game.CurrentScore);
        }

        [TestMethod]
        [ExpectedException(typeof(InvalidPinCountException))]
        public void Gooi5En6GeeftError()
        {
            var game = GetGame();
        ...
        [TestMethod]
        public void Gooi1GeeftScoreVoorFrame1Is1()
        {
            var game = GetGame();
        ...
        [TestMethod]
        public void DrieKeerGooi1GeeftScoreVoorFrame2Is3()
        {
            var game = GetGame();
        ...
        [TestMethod]
        public void DrieKeerGooi2GeeftScoreVoorFrame2Is2()
        {
            var game = GetGame();
            ...
            Assert.AreEqual(6, game.ScoreVoorFrame(2));
        }
        ...
        [TestMethod]
        public void TweeKeerGooi10EnGooi2ZorgtDat2WordtOpgeteldBijScoreVorigeFrames()
        {
            var game = GetGame();
            ...
            Assert.AreEqual(22, game.ScoreVoorFrame(1));
            Assert.AreEqual(34, game.ScoreVoorFrame(2));
        }       
        ...
        [TestMethod]
        [ExpectedException(typeof(GameNotActiveException))]
